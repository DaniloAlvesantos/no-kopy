  ...
  return (
    ...
    >
      <div className="md:my-6 mx-4">
        ...
        <p
          tabIndex={0}
          className="font-oswald text-[#e4e4e4] text-base sm:text-lg md:text-xl lg:text-2xl lg:my-8 my-4"
        >
        ...
        {skils.map((skill) => (
          ...
          >
            ...
            >
              ...
              <h3 tabIndex={0} className="font-poppins font-thin lg:text-xl">
                {skill.title}
              </h3>
            </span>
            <p
              tabIndex={0}
              className="font-poppins font-light text-center mt-2 bg-[#e4e4e4] text-primaryBlue-500 lg:text-lg rounded-md p-4"
            >
              {skill.text}
            </p>
          </div>
