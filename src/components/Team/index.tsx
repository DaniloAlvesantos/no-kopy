    ...
    <div tabIndex={0} className="rounded w-[18rem] h-[24rem] m-4 overflow-hidden relative group hover:shadow-cardShadow transition-all duration-500 ease-out">
      ...
      >
        <main className="relative">
          <span className="flex flex-col items-center justify-center text-center mt-4 font-poppins">
            <h2 className="font-normal text-xl leading-6 uppercase">{name}</h2>
            <h3 className="font-normal text-primaryPurple-500">{career}</h3>
          </span>
          <div className="w-full">
            <span className="absolute top-[4.6rem] left-0 bg-primaryPurple-500 rounded-md my-4 mx-2 p-2 w-[5rem] h-[5rem] flex items-center justify-center flex-col text-light-500 font-poppins font-light bg-opacity-80 ">
              <p>+{xp} XP</p>
              <p>{type}</p>
            </span>
