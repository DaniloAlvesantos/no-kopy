...
export const AsideBarMenu: React.FC<AsideBarMenuProps> = ({
  ...
  return (
    <aside
      ...
      } w-[14rem] h-full absolute top-0 left-0 bg-gradient-to-b from-darkBlue-500 to-primaryPurple-500 flex items-center justify-center flex-col z-20 duration-300 ease-in-out rounded-br rounded-tr md:hidden`}
    >
