  ...
  return (
    ...
    >
      <span className="absolute top-10 right-11">
        <img className="w-32 h-32 object-fill" src="nocopy-background.png" alt="" />
      </span>
      ...
      <ul className="absolute bottom-0 flex items-center justify-center">
        <li className="my-2 mx-1 object-fill"><img src="whatsapp.svg" alt="whatsapp" /></li>
        <li className="my-2 mx-1 object-fill"><img src="instagram.svg" alt="instagram" /></li>
        <li className="my-2 mx-1 object-fill"><img src="gmail.svg" alt="email" /></li>
      </ul>
    </aside>
  );
};
