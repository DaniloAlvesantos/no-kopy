...
export const Footer: React.FC = () => {
  return (
    <footer className="relative bg-gradient-to-r from-primaryPurple-500 via-primaryPurple-600 to-secondaryPurple-500 w-full h-[15rem] p-4 flex items-center justify-center">
      <img className="w-[12rem] h-[12rem] absolute left-0" src="/nocopy-background.png" alt="" />
      <div className="flex items-center flex-col text-light-500">
        ...
        <ul className="inline-flex group items-center justify-center gap-4 my-4">
